 ...
 */
package openfoodfacts.rackluxury.scrachx.openfood.features
...
import openfoodfacts.rackluxury.scrachx.openfood.AppFlavors
import openfoodfacts.rackluxury.scrachx.openfood.AppFlavors.OFF
import openfoodfacts.rackluxury.scrachx.openfood.AppFlavors.isFlavors
import openfoodfacts.rackluxury.scrachx.openfood.BuildConfig
...
import openfoodfacts.rackluxury.scrachx.openfood.customtabs.CustomTabActivityHelper
import openfoodfacts.rackluxury.scrachx.openfood.customtabs.CustomTabsHelper
import openfoodfacts.rackluxury.scrachx.openfood.customtabs.WebViewFallback
import openfoodfacts.rackluxury.scrachx.openfood.databinding.ActivityMainBinding
import openfoodfacts.rackluxury.scrachx.openfood.features.adapters.PhotosAdapter
import openfoodfacts.rackluxury.scrachx.openfood.features.additives.AdditiveListActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.allergensalert.AllergensAlertFragment
import openfoodfacts.rackluxury.scrachx.openfood.features.categories.activity.CategoryActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.changelog.ChangelogDialog
import openfoodfacts.rackluxury.scrachx.openfood.features.compare.ProductCompareActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.login.LoginActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.login.LoginActivity.Companion.LoginContract
import openfoodfacts.rackluxury.scrachx.openfood.features.preferences.PreferencesFragment
import openfoodfacts.rackluxury.scrachx.openfood.features.product.edit.ProductEditActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.productlists.ProductListsActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.scanhistory.ScanHistoryActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.searchbycode.SearchByCodeFragment
import openfoodfacts.rackluxury.scrachx.openfood.features.shared.BaseActivity
import openfoodfacts.rackluxury.scrachx.openfood.images.ProductImage
import openfoodfacts.rackluxury.scrachx.openfood.jobs.ProductUploaderWorker.Companion.scheduleProductUpload
import openfoodfacts.rackluxury.scrachx.openfood.listeners.CommonBottomListenerInstaller.installBottomNavigation
import openfoodfacts.rackluxury.scrachx.openfood.listeners.CommonBottomListenerInstaller.selectNavigationItem
import openfoodfacts.rackluxury.scrachx.openfood.models.Product
import openfoodfacts.rackluxury.scrachx.openfood.models.ProductImageField
import openfoodfacts.rackluxury.scrachx.openfood.network.OpenFoodAPIClient
import openfoodfacts.rackluxury.scrachx.openfood.utils.*
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.*
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_ABOUT
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_ADDITIVES
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_ADVANCED_SEARCH
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_ALERT
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_CATEGORIES
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_COMPARE
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_CONTRIBUTE
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_HISTORY
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_HOME
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_INCOMPLETE_PRODUCTS
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_LOGIN
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_LOGOUT
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_MANAGE_ACCOUNT
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_MY_CONTRIBUTIONS
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_OBF
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_PREFERENCES
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_SCAN
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_SEARCH_BY_CODE
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_USER
import openfoodfacts.rackluxury.scrachx.openfood.utils.NavigationDrawerListener.Companion.ITEM_YOUR_LISTS
import openfoodfacts.rackluxury.scrachx.openfood.utils.Utils.scheduleProductUploadJob
...
import openfoodfacts.rackluxury.scrachx.openfood.features.search.ProductSearchActivity.Companion.start as startSearch
