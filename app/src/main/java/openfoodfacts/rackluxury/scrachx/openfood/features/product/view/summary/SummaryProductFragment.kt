 ...
 */
package openfoodfacts.rackluxury.scrachx.openfood.features.product.view.summary
...
import openfoodfacts.rackluxury.scrachx.openfood.databinding.FragmentSummaryProductBinding
import openfoodfacts.rackluxury.scrachx.openfood.features.FullScreenActivityOpener
import openfoodfacts.rackluxury.scrachx.openfood.features.ImagesManageActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.additives.AdditiveFragmentHelper.showAdditives
import openfoodfacts.rackluxury.scrachx.openfood.features.compare.ProductCompareActivity.Companion.start
...
import openfoodfacts.rackluxury.scrachx.openfood.features.product.edit.ProductEditActivity.Companion.KEY_STATE
import openfoodfacts.rackluxury.scrachx.openfood.features.product.view.CategoryProductHelper
import openfoodfacts.rackluxury.scrachx.openfood.features.product.view.ProductViewActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.product.view.ingredients_analysis.IngredientsWithTagDialogFragment
import openfoodfacts.rackluxury.scrachx.openfood.features.productlist.ProductListActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.productlists.ProductListsActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.productlists.ProductListsActivity.Companion.getProductListsDaoWithDefaultList
import openfoodfacts.rackluxury.scrachx.openfood.features.search.ProductSearchActivity
import openfoodfacts.rackluxury.scrachx.openfood.features.shared.BaseFragment
import openfoodfacts.rackluxury.scrachx.openfood.features.shared.adapters.NutrientLevelListAdapter
import openfoodfacts.rackluxury.scrachx.openfood.features.shared.views.showQuestionDialog
import openfoodfacts.rackluxury.scrachx.openfood.images.ProductImage
import openfoodfacts.rackluxury.scrachx.openfood.models.*
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.ListedProduct
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.ListedProductDao
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.additive.AdditiveName
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.allergen.AllergenHelper
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.allergen.AllergenName
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.analysistagconfig.AnalysisTagConfig
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.category.CategoryName
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.label.LabelName
import openfoodfacts.rackluxury.scrachx.openfood.models.entities.tag.TagDao
import openfoodfacts.rackluxury.scrachx.openfood.network.OpenFoodAPIClient
import openfoodfacts.rackluxury.scrachx.openfood.network.WikiDataApiClient
